  ...
  useEffect(() => {
    const fetchAssessments = async () => {
      ...
      if (res.ok) {
        ...
        setAssessments(data.filter((a: any) => a.scores.length > 0));
      }
    };
    fetchAssessments();
  }, []);
...
export default function AnalyticsPage() {
  ...
  // More chart data calculations will go here
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <RadarChart data={categoryChartData}>
              ...
              <Legend />
              <Radar name="Cat 1" dataKey="1" stroke="#8884d8" fill="#8884d8" fillOpacity={0.6} />
              <Radar name="Cat 2" dataKey="2" stroke="#82ca9d" fill="#82ca9d" fillOpacity={0.6} />
