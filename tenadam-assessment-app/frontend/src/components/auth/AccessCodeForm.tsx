  ...
  return (
    <div className="w-full space-y-6">
        <div className="text-center">
          <div className="mx-auto h-10 w-10 flex items-center justify-center rounded-full bg-blue-100 mb-4">
            <svg
          ...
          <p className="text-xs sm:text-sm text-gray-600">
            Enter your access code to begin the Baldrige Excellence Framework Assessment
          </p>
        </div>

        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            <label htmlFor="access-code" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
              Access Code
            </label>
            <input
              id="access-code"
              ...
              type="text"
              required
              className="appearance-none relative block w-full px-3 py-2 sm:py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 text-center text-sm sm:text-base font-mono tracking-wide"
